...
namespace WCSMCL.Modules.Const
{
    /// <summary>
    /// 路径常量表
    /// </summary>
    public class PathConst
    {
        ...
        public static string DownloaderPath = $"{Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "wcsmcl","temp")}{X}wonderLab.desktop{(InfoConst.IsWindows ? ".exe" : "")}";

        public static string SettingJsonPtah = $"{Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "wcsmcl")}{X}mainsetting.json";

        public static string OtherJsonPtah = $"{Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "wcsmcl")}{X}other.json";

        public static string MainDirectory = $"{Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "wcsmcl")}";

        public static string TempDirectory = $"{Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "wcsmcl")}{X}temp";
